...
<!--                    <li class="nav-item merchant-order-add">
            ...
            <li class="heading">
                <h3 class="uppercase">Store API</h3>
            </li>
                ...
                <ul class="sub-menu">
                    <li class="nav-item store-manage">
                        <a href="{{ secure_url('store') }}" class="nav-link ">
                            <span class="title">Store API</span>
                        </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item warehouses">
                <a href="javascript:;" class="nav-link nav-toggle">
                    ...
                    <span class="title">Pick up locations</span>
                    <span class="arrow"></span>
                </a>
                <ul class="sub-menu">
                    <li class="nav-item warehouse-add">
                        <a href="{{ secure_url('warehouse/create') }}" class="nav-link ">
                            <span class="title">Add</span>
                        </a>
                    </li>
                    <li class="nav-item warehouse-manage">
                        <a href="{{ secure_url('warehouse') }}" class="nav-link ">
                            <span class="title">Manage</span>
                        </a>
                    </li>
                </ul>
