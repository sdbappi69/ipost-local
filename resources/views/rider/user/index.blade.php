        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase">New Rider</span>
                </div>
                <div class="tools"> </div>
            </div>
                ...
                <table class="table table-striped table-bordered table-hover dt-responsive" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $user->email }}</td>
                            <td>{{ $user->msisdn }}</td>
                            <td>{!! $user->rider_type == 1 ? '<span class="label label-success"> Permanent </span>' : '<span class="label label-danger"> Freelancer </span>' !!}</td>
                            ...
                            <td>
                                <div class="btn-group pull-right">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li>
                                            <a href="rider-user/{{ $user->id }}/edit">
...
<script type="text/javascript">
    ...
    highlight_nav('rider-manage', 'users');
    $('#example0').DataTable({
    "order": [],
    });
    loadStoreDataTable();
