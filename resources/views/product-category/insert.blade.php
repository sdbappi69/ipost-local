...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{ secure_url('hub') }}">Product Categories</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span>Insert</span>
    ...
    {!! Form::open(array('url' => secure_url('') . '/product-category', 'method' => 'post')) !!}
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                {!! Form::select('vehicle_type_id[]', $vehicleTypes, null, ['class' => 'form-control','id'=>'vehicle_type_id','multiple','Select Vehicle']) !!}
            </div>
