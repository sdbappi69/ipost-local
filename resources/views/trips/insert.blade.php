        ...
        <table class="table table-bordered table-hover" id="example0">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a class="btn btn-info btn-xs" target="_blank" href="{{secure_url('common-invoice-single/'.$sub_order->suborder_id)}}">Invoice</a>
              </td>
...
<div class="col-md-6 animated flipInX">
  ...
  <div class="portlet light tasks-widget bordered" style="overflow: hidden;">
    ...
    <div class="portlet-title">
        <div class="caption">
            <i class="icon-edit font-dark"></i>
            <span class="caption-subject font-dark bold uppercase">Create Trip</span>
        </div>
    </div>
    ...
    <div class="portlet-body util-btn-margin-bottom-5">
      ...
      <div class="col-md-12" style="margin-bottom:5px;">
           {!! Form::select('tripconsignment_selection_id',['' => 'New Trip']+$tripconsignments,old('tripconsignment_selection_id'), ['class' => 'form-control js-example-basic-single', 'id' => 'tripconsignment_selection_id']) !!}
      </div>

      <div class="tripconsignment update-tripconsignment" style="display: none;">
        {!! Form::open(array('url' => secure_url('') . '/update-tripconsignments-trip-submit', 'method' => 'post')) !!}

          <input type="hidden" value="" class="form-control" name="tripconsignment_id" id="tripconsignment_id">
      ...
      <div class="tripconsignment create-tripconsignment">
        {!! Form::open(array('url' => secure_url('') . '/trip', 'method' => 'post')) !!}

          @include('partials.errors')

          <div class="col-md-12" style="margin-bottom:5px;">
            {!! Form::select('driver_id', array(''=>'Select Rider')+$drivers, null, ['class' => 'form-control js-example-basic-single', 'required' => 'required', 'id' => 'driver_id']) !!}
          </div>
...
<!--          <div class="col-md-12" style="margin-bottom:5px;">
          ...
          <div class="col-md-12" style="margin-bottom:5px;">
            {!! Form::textarea('remarks', null, ['class' => 'form-control', 'id' => 'remarks','placeholder'=>'Remarks..........']) !!}
          </div>-->

          <div class="col-md-12" style="margin-bottom:5px;">
               <button type="submit" class="btn btn-primary col-md-12"><i class="fa fa-check"></i> Create</button>
          </div>
...
<script type="text/javascript">
    ...
    $(document ).ready(function() {
        ...
        highlight_nav('trip-create', 'trips');
    ...
    $('#tripconsignment_selection_id').on('change', function() {
      $('.tripconsignment').hide(10);
      if(this.value == ''){
        $('.create-tripconsignment').show(10);
      }else{
        $('#tripconsignment_id').val(this.value);
        $('.update-tripconsignment').show(10);

        $('.loaded-suborder').html('');
        var url = site_path + 'on_trip/'+this.value;
