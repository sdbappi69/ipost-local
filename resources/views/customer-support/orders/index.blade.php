...
<div class="col-md-12">
    ...
    <div class="portlet light tasks-widget bordered">
        ...
        <div class="portlet-title">
            <div class="caption">
                <i class="icon-edit font-dark"></i>
                <span class="caption-subject font-dark bold uppercase">Orders - {{$sub_orders->total()}}</span>
            </div>
            <div class="tools">
            ...
            <table class="table table-striped table-bordered table-hover dt-responsive my_datatable" id="example0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @permission('manage_customer_support_order')
                        <td>
                            <button data-toggle="modal" data-target="#submit_order_complain_{{$sub_order->suborder_id}}" class="btn btn-warning btn-xs">
                        ...
                        @include('customer-support.complain.submit_order_complain_modal')
                        @endpermission
                        <td>
                            <!-- <b>Order:</b> -->
