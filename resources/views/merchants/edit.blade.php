...
@section('content')
    ...
    <div class="mt-element-step">
        <div class="row step-background-thin">
            <a href="{{ secure_url('merchant/'.$merchant->id.'/edit?step=1') }}">
            ...
            <a href="{{ secure_url('merchant/'.$merchant->id.'/edit?step=2') }}">
            ...
            <a href="{{ secure_url('merchant/'.$merchant->id.'/edit?step=3') }}">
