...
<div class="col-md-12">
    ...
    <div class="portlet light tasks-widget bordered animated flipInX">
        ...
        highlight_nav('tat-delivery', 'tat');
...
<script type="text/javascript">
    ...
    $(".filter-btn").click(function(e){
        e.preventDefault();
        $('#filter-form').attr('action', "{{ secure_url('tat/delivery') }}").submit();
    });

    $(".export-btn").click(function(e){
        // alert(1);
        e.preventDefault();
        $('#filter-form').attr('action', "{{ secure_url('tat/deliveryexport/xls') }}").submit();
    });
