...
<div class="col-md-12">
    ...
    <div class="portlet light tasks-widget bordered animated flipInX">
                    ...
                    <div class="portlet-body util-btn-margin-bottom-5">
                        <table class="table table-striped table-bordered table-hover dt-responsive my_datatable" id="example0">
                            <thead>
                                ...
                                <!-- <th>Pickup Requested</th> -->

                                <th>Pickup Hub</th>

                                <th>Racked at destination hub</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $order_log->pickup_hub or '' }}</td>

                                    <td>{{ $order_log->racked_at_destination_hub or '' }}</td>
                                    <td>{{ $order_log->delivery_attempt or '' }}</td>
                                    <td>{{ $order_log->delivery_date or '' }}</td>
                                    <td>{{ $order_log->delivery_hub or '' }}</td>
                                    <td>{{ $order_log->aging or '' }}</td>
        ...
        highlight_nav('aging-delivery', 'aging');
...
<script type="text/javascript">
    ...
    $(".filter-btn").click(function(e){
        e.preventDefault();
        $('#filter-form').attr('action', "{{ secure_url('aging/delivery') }}").submit();
    });

    $(".export-btn").click(function(e){
        // alert(1);
        e.preventDefault();
        $('#filter-form').attr('action', "{{ secure_url('aging/deliveryexport/xls') }}").submit();
    });
