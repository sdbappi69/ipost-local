...
<div class="col-md-12">
    ...
    <div class="portlet light tasks-widget bordered animated flipInX">
                        ...
                        <table class="table table-striped table-bordered table-hover dt-responsive my_datatable" id="example0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $order_log->pickup_requested or '' }}</td>
                                    <td>{{ $order_log->pickup_attempt or '' }}</td>
                                    <td>{{ $order_log->pickup_hub or '' }}</td>
                                    <td>{{ $order_log->picked_date or '' }}</td>
        ...
        highlight_nav('aging-pickup', 'aging');
...
<script type="text/javascript">
    ...
    $(".filter-btn").click(function(e){
        e.preventDefault();
        $('#filter-form').attr('action', "{{ secure_url('aging/pickup') }}").submit();
    });

    $(".export-btn").click(function(e){
        // alert(1);
        e.preventDefault();
        $('#filter-form').attr('action', "{{ secure_url('aging/pickupexport/xls') }}").submit();
    });
