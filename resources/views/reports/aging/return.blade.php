...
<div class="col-md-12">
    ...
    <div class="portlet light tasks-widget bordered animated flipInX">
                        ...
                        <table class="table table-striped table-bordered table-hover dt-responsive my_datatable" id="example0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $order_log->return_date or '' }}</td>
        ...
        highlight_nav('aging-return', 'aging');
...
<script type="text/javascript">
    ...
    $(".filter-btn").click(function(e){
        e.preventDefault();
        $('#filter-form').attr('action', "{{ secure_url('aging/return') }}").submit();
    });

    $(".export-btn").click(function(e){
        // alert(1);
        e.preventDefault();
        $('#filter-form').attr('action', "{{ secure_url('aging/returnexport/xls') }}").submit();
    });
