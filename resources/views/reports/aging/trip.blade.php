...
<div class="col-md-12">
    ...
    <div class="portlet light tasks-widget bordered animated flipInX">
                    ...
                    <div class="portlet-body util-btn-margin-bottom-5">
                        <table class="table table-striped table-bordered table-hover dt-responsive my_datatable" id="example0">
                            <thead>
                                ...
                                <th>Product racked at Pickup hub</th>

                                <th>Product racked at Delivery hub</th>
                                <th>Delivery Hub</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $order_log->product_racked_at_pickup_hub or '' }}</td>
                                    <td>{{ $order_log->product_racked_at_delivery_hub or '' }}</td>
        ...
        highlight_nav('aging-trip', 'aging');
