...
@section('content')
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    @if($clone == '1')
                        {!! Form::select('product_category_id', $categories, null, ['class' => 'form-control js-example-basic-single', 'required' => 'required', 'id' => 'product_category_id']) !!}

                        {!! Form::hidden('store_id', $store_id, ['required' => 'required']) !!}
                    @else
                        {!! Form::select('product_category_id', [''=>'Select Product Category']+$categories, null, ['class' => 'form-control js-example-basic-single', 'required' => 'required', 'id' => 'product_category_id']) !!}
                    @endif
                </div>
    ...
    <script type="text/javascript">
        ...
        $(document ).ready(function() {
            ...
            highlight_nav('charge-add', 'charges');
        });
