...
@section('content')
    ...
    <div class="mt-element-step">
        <div class="row step-background-thin">
            <a href="{{ URL::to('user/'.$user->id.'/edit?step=1') }}">
            ...
            <a href="{{ URL::to('user/'.$user->id.'/edit?step=2') }}">
            ...
            <a href="{{ URL::to('user/'.$user->id.'/edit?step=3') }}">
            ...
            <a href="{{ URL::to('user/'.$user->id.'/edit?step=4') }}">
