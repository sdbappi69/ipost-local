        ...
        <div class="portlet light tasks-widget bordered">
            ...
            <div class="portlet-body util-btn-margin-bottom-5">
                <div class="table-responsive cart_products">
                    ...
                    @endif
                    {!! Form::model($order, array('url' => secure_url('') . '/merchant-orderv2/'.$order->id.'?step=complete', 'method' => 'put')) !!}
                        ...
                        <div class="row padding-top-10">
                            <a href="{{ secure_url('merchant-orderv2/'.$id.'/edit?step=1') }}" class="btn default"> Back </a>
                             @if(count($order->cart_products) > 0)
