        ...
        @foreach($temp_arrays as $temp_array)
            <tr>
                ...
                <td style="border: 1px solid #000000; padding:2px;">
                    ...
                    <br>
                    Address: {{ $temp_array->address1 }}, {{ $temp_array->zone_name }}, {{ $temp_array->city_name }}
                    , {{ $temp_array->state_name }}
                </td>
                ...
                <td style="border: 1px solid #000000; padding:2px;">
                    <b>
                        Merchant : {{ $temp_array->merchant_name }}<br>
                        Order Id : {{ $temp_array->merchant_order_id }}<br>
                    </b>
                    Product : {{ $temp_array->product_title }}<br>
                    Qty : {{ $temp_array->quantity }}<br>
                </td>
                <td style="border: 1px solid #000000; padding:2px;"></td>
