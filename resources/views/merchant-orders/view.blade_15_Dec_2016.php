...
@section('content')
    ...
    <div class="mt-element-step">
        <div class="row step-line">
            ...
            <div class="col-md-3 mt-step-col @if($order->order_status >= 9) done @elseIf($order->order_status >= 5) active @endIf ">
            ...
            <div class="col-md-3 mt-step-col last @if($order->order_status == 10) done @elseIf($order->order_status == 9) active @endIf ">
                                ...
                                @foreach($order->products as $row)
                                    <tr>
                                        ...
                                        <td>
                                            @if($row->status == 10)
                                                Delivered
                                                {{--*/ $lat = $row->order->delivery_latitude /*--}}
                                                {{--*/ $lon = $row->order->delivery_longitude /*--}}
                                            @elseIf($row->status >= 9)
                                                Shipping
                                                {{--*/ $lat = $row->picker->latitude /*--}}
                                                {{--*/ $lon = $row->picker->longitude /*--}}
                                            @elseIf($row->status >= 5)
                                                Picked
                                                {{--*/ $lat = $row->order->hub->latitude /*--}}
                                                {{--*/ $lon = $row->order->hub->longitude /*--}}
                                            @elseIf($row->status > 1)
                                                Verified
                                                {{--*/ $lat = $row->pickup_location->latitude /*--}}
                                                {{--*/ $lon = $row->pickup_location->longitude /*--}}
                                            @elseIf($row->status == 1)
                                                Pending
                                                {{--*/ $lat = $row->pickup_location->latitude /*--}}
                                                {{--*/ $lon = $row->pickup_location->longitude /*--}}
                                        ...
                                        <td>
                                            <a href="{{ URL::to('maps') }}/{{ $lat }}/{{ $lon }}" target="_blank">
