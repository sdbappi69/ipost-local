                            ...
                            <div class="easy-pie-chart">
                                ...
                                <?php
                                    if($total_delivery_req != 0 && $processing_delivery_req != 0){
                                        $processing_delivery = ($processing_delivery_req / $total_delivery_req) * 100;
                                    }else{
...
<div class="row">
                        ...
                        <div class="easy-pie-chart">
                            ...
                            <?php
                                if($total_return_req != 0 && $processing_return_req != 0){
                                    $processing_return = ($processing_return_req / $total_return_req) * 100;
                                }else{
                                    $processing_return = 0;
                                }
                            ?>
    ...
    <div class="col-md-2">
        ...
        <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
            <h4 class="widget-thumb-heading">Order on Draft</h4>
            <div class="widget-thumb-wrap">
                {{-- <i class="widget-thumb-icon bg-green icon-bulb"></i> --}}
                <div class="widget-thumb-body">
                    {{-- <span class="widget-thumb-subtitle">Product</span> --}}
                    <span class="widget-thumb-body-stat" data-counter="counterup" data-value="{{ $orders_in_draft }}">0</span>
                </div>
    ...
    <div class="col-md-2">
        <!-- BEGIN WIDGET THUMB -->
        <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
            <h4 class="widget-thumb-heading">Total Active Stores</h4>
            <div class="widget-thumb-wrap">
                {{-- <i class="widget-thumb-icon bg-green icon-bulb"></i> --}}
                <div class="widget-thumb-body">
                    {{-- <span class="widget-thumb-subtitle">Product</span> --}}
                    <span class="widget-thumb-body-stat" data-counter="counterup" data-value="{{ $total_stores }}">0</span>
                </div>
    ...
    <div class="col-md-2">
        <!-- BEGIN WIDGET THUMB -->
        <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
            <h4 class="widget-thumb-heading">Picking Locations</h4>
            <div class="widget-thumb-wrap">
                {{-- <i class="widget-thumb-icon bg-green icon-bulb"></i> --}}
                <div class="widget-thumb-body">
                    {{-- <span class="widget-thumb-subtitle">Product</span> --}}
                    <span class="widget-thumb-body-stat" data-counter="counterup" data-value="{{ $total_picking_locations }}">0</span>
                </div>
...
<div class="row">
    ...
    <div class="col-md-12 col-sm-12">
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption ">
                    <span class="caption-subject font-dark bold uppercase">Currecnt Status</span>
                    <span class="caption-helper">Created or last updated between {{ $from_date }} to {{ $to_date }}</span>
                </div>
            </div>
            <div class="portlet-body">
    ...
    var Dashboard = function() {
        ...
        return {
            ...
            initAmChart4: function() {
                ...
                <?php $merchantAllStatus = merchantPieStatus(); ?>
                ...
                var chart = AmCharts.makeChart("dashboard_amchart_4", {
                    ...
                    "dataProvider": [
                        @foreach($merchantAllStatus AS $key => $item)
                            {
                                "country": "{{ $item }}",
                                "value": {{ merchantCountStatus($key, $from_date, $to_date) }}
                            },
                        @endforeach
                    ],
                    "valueField": "value",
