    ...
    <div class="portlet light tasks-widget bordered animated flipInX">
        ...
        <div class="portlet-body util-btn-margin-bottom-5">
            ...
            <div class="col-md-4">
                ...
                {!! Form::select('bank_id', array(''=>'Select bank') + $bank, null, ['class' => 'form-control js-example-basic-single', 'id' => 'id']) !!}
            </div>
            ...
            <table class="table table-bordered table-hover" id="example0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $bank_account->bank->name or "N/A"}}</td>
                        <td>{{ $bank_account->account_no }}</td>
                        <td>{{ $bank_account->account_of }}</td>
                        <td>
                            <a href="{{secure_url('/bank-accounts/'.$bank_account->id.'/edit')}}" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i></a>
                        </td>
