...
class TaskController extends Controller
{
      ...
      */
      if( $send_lat != 0 && $send_long != 0 )
      {
         $tasks      =  OrderProduct::select(
                        ...
                        ->join('picking_task AS pt', 'pt.product_unique_id', '=', 'order_product.product_unique_id')
                        ->join('consignments AS consignments', 'consignments.id', '=', 'pt.consignment_id')
    ...
    */
    public function picking_delivery_completed()
    {
      ...
      $feedback['response']['task']    =  $picking_task_lists;
